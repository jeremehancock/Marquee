...
| `DEFAULT_SORT` | Install default gallery sort. One of `alphabetical`, `alphabetical_desc`, `date_added`, `date_added_asc`, `release`, `release_desc`. Users can still switch field and direction in the gallery. | `alphabetical` |
